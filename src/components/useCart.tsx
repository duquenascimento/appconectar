...
import { getToken, getStorage, setStorage, deleteStorage } from '@/app/utils/utils'
import { saveProductObservations } from '@/app/utils/productObservation'
        ...
        setCart((prevCart) => {
          ...
          if (cart.obs) {
            setProductObservations((prev) => {
              ...
              saveProductObservations(updated).catch((err) => console.error('Erro ao salvar observações no AsyncStorage:', err))
              return updated
            })
          }
