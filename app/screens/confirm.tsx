            ...
            try {
              ...
              if (isBefore13Hours()) {
                ...
                try {
                  ...
                  console.log("Agendamento enviado via ChatGuru");
                } catch (error) {
                ...
                if (
                  !isOpen() &&
                  !selectedRestaurant.restaurant.allowClosedSupplier
                )
                ...
                if (
                  ...
                  erros.push(
                    "O valor do pedido não atingiu o mínimo do fornecedor"
                  );
                ...
                if (!erros.length) {
                  const result = await fetch(
                    `${process.env.EXPO_PUBLIC_API_URL}/confirm`,
                    {
                      method: "POST",
                      headers: {
                        "Content-Type": "application/json",
