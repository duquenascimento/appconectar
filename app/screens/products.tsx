    ...
    <Dialog modal open={props.openModal}>
      ...
      <Dialog.Portal>
        ...
        >
          ...
          <Dialog.Description>Entre em contato conosco para agendar um contato rápido e começar a utilizar o aplicativo!</Dialog.Description>
 ...
 */ const favs = await loadFavorites()
  ...
  return (
    <Stack pt={20} backgroundColor="#f9f9f9" height="100%" position="relative">
      <DialogComercialInstance openModal={showRegistrationReleasedNewApp} setRegisterInvalid={setShowRegistrationReleasedNewApp} rest={restaurantes} />
